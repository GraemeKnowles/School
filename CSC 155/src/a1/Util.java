...
class Util {
	...
	static class OGL {		
		...
		/**
		 * 
		 * @param vertexShader the path of the vertex shader to load
		 * @param fragmentShader the path of the fragment shader to load
		 ...
		 * @param shader the OpenGL shader index of the shader to print
		...
		/**
		 * Modified return value from book example
		 * @param prog the OpenGL program index whose program log to print
